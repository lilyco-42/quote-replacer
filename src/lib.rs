...
pub mod app {
    ...
    impl QuoteReplacer {
        ...
        pub fn delete_mapping(&mut self, index: usize) {
            if index
                < self
                    .settings
                    .mappings
        ...
        eframe::run_native(
            ...
            Box::new(|cc| {
                ...
                if let Ok(font_data) = std::fs::read(font_path) {
                    fonts.font_data.insert("NerdFont".to_owned(), egui::FontData::from_owned(font_data));
